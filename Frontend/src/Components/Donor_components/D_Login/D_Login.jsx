...
//                                 <Link to="/donor_signup" className="text-our_red font-bold hover:underline">
//                                     Sign Up
//                                 </Link>
//                             </p>
//                         </div>
...
function Donor_Login() {
    ...
    return (
        <div className="min-h-screen font-nunito bg-gray-100 relative overflow-hidden">
            ...
            {/* Back button */}
            <div className='container mx-auto px-4 py-10 relative z-30'>
                <button
                    onClick={() => navigate("/")}
                    className="bg-white text-our_red rounded-full w-8 h-8 hover:bg-white hover:text-our_red hover:border-2 hover:border-our_red hover:font-bold transition flex flex-row justify-center items-center gap-3 md:ml-6"
                >
                    <IoArrowUndo size={20} />
                </button>
            </div>
            ...
            {/* Main content */}
            <div className="container mx-auto px-4 py-10 flex flex-col lg:flex-row justify-center items-center gap-6 lg:gap-10 relative z-20">
                {/* Left side - Welcome message */}
                <div className='w-full lg:w-1/2 max-w-xl text-center lg:text-left px-4 lg:pl-20 relative z-40'>
                ...
                <div className="w-full max-w-md bg-white bg-opacity-10 backdrop-blur-lg rounded-xl shadow-2xl shadow-gray-400 p-6 sm:p-8">
                    <form onSubmit={handleSubmit} encType="multipart/form-data">
                        ...
                        <div className='space-y-5 sm:space-y-6'>
                            <div className="flex flex-col gap-1">
                                <div className="flex items-center gap-3 bg-white bg-opacity-80 px-4 sm:px-5  border border-gray-300 rounded-full">
                                    ...
                                    <input
                                        ...
                                        required
                                        id="email"
                                        className="w-full font-bold placeholder:font-bold placeholder-gray-400 focus:outline-none border-none bg-transparent"
                                        placeholder="Email"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 bg-white bg-opacity-80 px-4 sm:px-5 border border-gray-300 rounded-full">
                                ...
                                <input
                                    ...
                                    required
                                    id="password"
                                    className="bg-transparent font-bold placeholder:font-bold placeholder-gray-400 focus:outline-none w-full border-none"
                                    placeholder="Password"
                                />
                            </div>
                        </div>
                        ...
                        <div className="mt-8 text-center">
                            <button
                                type="submit"
                                className="bg-[#820000] border-2 border-[#820000] text-white font-nunito font-bold py-2 px-6 sm:px-8 rounded-full hover:bg-white hover:text-[#820000] hover:border-2 hover:border-[#820000] transition duration-300 w-full sm:w-auto"
                            >
                                Login
                            </button>
