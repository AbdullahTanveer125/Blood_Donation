...
function Footer1() {
    return (
        <div className='font-nunito'>
            <footer className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 md:gap-12 lg:gap-20 px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-12 sm:py-16 md:py-20 bg-gray-200 text-base-content">
                {/* Logo and Company Info */}
                <aside className='flex flex-col items-center md:items-start space-y-4 w-full md:w-auto text-center md:text-left'>
                    <svg
                        width="50"
                        height="50"
                        viewBox="0 0 24 24"
                ...
                {/* Navigation Links */}
                <div className="grid grid-cols-2 md:flex gap-8 md:gap-12 lg:gap-20 w-full md:w-auto">
                    {/* Services */}
                    <nav className='flex flex-col space-y-2 sm:space-y-3'>
                        <h6 className="font-bold sm:font-extrabold text-sm sm:text-base">Services</h6>
                        ...
                        <a className="link link-hover text-xs sm:text-sm">Advertisement</a>
                    </nav>

                    {/* Company */}
                    <nav className='flex flex-col space-y-2 sm:space-y-3'>
                        <h6 className="font-bold sm:font-extrabold text-sm sm:text-base">Company</h6>
                    ...
                    {/* Legal */}
                    <nav className='flex flex-col space-y-2 sm:space-y-3'>
                        <h6 className="font-bold sm:font-extrabold text-sm sm:text-base">Legal</h6>
