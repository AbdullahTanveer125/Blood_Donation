        ...
        <div className='font-nunito'>
            <footer className="bg-neutral text-gray-200">
                <div className="container mx-auto px-4 sm:px-6 py-5 sm:py-7">
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                        {/* Copyright Section */}
                        <aside className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                            {/* <svg
                                ...
                                fillRule="evenodd"
                                clipRule="evenodd"
                                className="fill-current h-6 w-6 sm:h-8 sm:w-8 md:h-9 md:w-9"
                            >
                                <path
                        ...
                        {/* Social Media Links */}
                        <nav className="flex gap-3 sm:gap-4 md:gap-5">
