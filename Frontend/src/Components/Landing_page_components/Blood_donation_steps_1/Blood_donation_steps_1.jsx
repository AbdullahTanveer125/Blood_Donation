...
function Blood_donation_steps_1() {
    return (
        <div className='pt-10 sm:pt-16 md:pt-20 lg:pt-28 px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32 font-nunito'>
            <div className='text-center'>
                <h1 className='text-xl sm:text-3xl md:text-4xl font-bold'>
                    Your <span className='text-our_red'>Blood Donation</span> Process
                </h1>
                <p className='text-xs sm:text-base mt-2 sm:mt-3 md:mt-4 max-w-[90%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60%] mx-auto'>
                    Follow this simple process to donate blood safely and make a real difference
                </p>
            </div>

            <ul className="pt-10 sm:pt-14 md:pt-16 lg:pt-20 timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
                {/* Step 1 */}
                <li>
                    <div className="timeline-middle">
                        <svg
                    ...
                    <div className="timeline-start mb-8 sm:mb-10 md:text-end">
                        <time className="text-sm sm:text-lg font-black text-our_red">Step-1</time>
                        <div className="text-xs sm:text-lg font-black">Sign Up</div>
                        <p className='text-xs sm:text-base bg-gray-100 rounded-md p-3 shadow-md shadow-gray-300'>
                            Create your donor account by logging in securely with basic details and selecting your blood group and location preferences.
                        </p>
                    </div>
                    <hr />
                ...
                <li>
                    ...
                    <div className="timeline-end mb-8 sm:mb-10">
                        <time className="text-sm sm:text-lg font-black text-our_red">Step-2</time>
                        <div className="text-xs sm:text-lg font-black">Search Request</div>
                        <p className='text-xs sm:text-base bg-gray-100 rounded-md p-3 shadow-md shadow-gray-300'>
                            Browse real-time blood requests filtered by your blood type and the nearest hospital or recipient location around you.
                        </p>
                    </div>
                ...
                <li>
                    ...
                    <div className="timeline-start mb-8 sm:mb-10 md:text-end">
                        <time className="text-sm sm:text-lg font-black text-our_red">Step-3</time>
                        <div className="text-xs sm:text-lg font-black">View Matches</div>
                        <p className='text-xs sm:text-base bg-gray-100 rounded-md p-3 shadow-md shadow-gray-300'>
                            See a list of recipients who match your blood type and are urgently in need of blood in your area.
                        </p>
                    </div>
                ...
                <li>
                    ...
                    <div className="timeline-end mb-8 sm:mb-10">
                        <time className="text-sm sm:text-lg font-black text-our_red">Step-4</time>
                        <div className="text-xs sm:text-lg font-black">Connect</div>
                        <p className='text-xs sm:text-base bg-gray-100 rounded-md p-3 shadow-md shadow-gray-300'>
                            Contact the recipient directly using their phone number or start a secure in-site chat through our platform.
                        </p>
                    </div>
                ...
                <li>
                    ...
                    <div className="timeline-start mb-8 sm:mb-10 md:text-end">
                        <time className="text-sm sm:text-lg font-black text-our_red">Step-5</time>
                        <div className="text-xs sm:text-lg font-black">Donate Blood</div>
                        <p className='text-xs sm:text-base bg-gray-100 rounded-md p-3 shadow-md shadow-gray-300'>
                            Visit the specified hospital or donation point to give blood and make a life-saving difference in just one visit.
                        </p>
                    </div>
