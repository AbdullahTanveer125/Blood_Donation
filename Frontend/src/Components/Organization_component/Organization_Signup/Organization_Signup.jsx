...
//                                     <Link to="/organization_login" className="text-our_red font-bold hover:underline">
//                                         Login
//                                     </Link>
//                                 </p>
//                             </div>
...
// import {
//     FaKey, FaUserAlt, FaPhoneVolume,
//     FaRegAddressBook, MdEmail, IoArrowUndo, FaLink
...
function Organization_Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        data.append("person", "organization");

        try {
            const res = await axios.post(`http://localhost:5000/organization/signup`, data);
            if (res.data.success) {
            ...
            <div className="container mx-auto px-4 py-8 sm:py-12 flex flex-col lg:flex-row items-center justify-center gap-8 sm:gap-12 lg:gap-16">
                ...
                <div className="w-full lg:w-1/3 text-center lg:text-left bg-white bg-opacity-70 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                    ...
                    <p className='text-sm sm:text-base'>
                        Register your organization to connect with donors and help save lives.
                    </p>
                </div>
